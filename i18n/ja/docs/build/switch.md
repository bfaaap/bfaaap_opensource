...
部品＝**ROHM `RU1J002YN`**。完全な参照回路は
[`device-switch-electronic/hardware/`](../../../../device-switch-electronic/hardware/) を参照。
...
## ステップ4 —— ペアリング・使用
[iOSアプリ](ios.md)をビルド/インストールし、Bluetooth で接続、**オフセット（しきい値）**と**倍率**をプリセットして演奏します（この2つで応答速度が決まります）。
