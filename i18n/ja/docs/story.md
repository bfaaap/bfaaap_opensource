...
核となる考え —— 頭部角度の**オフセット（不感帯）**と**乗数**（この2つが二次的な**応答速度**を決める）—— は2018年に **PCT国際特許**として出願され、のちに日本で
...
| ![Fehmiju Fati](../../../docs/members/member2020.png) | **Fehmiju Fati** | **作曲／コンピュータ音楽**。国際的な受賞歴。日本でコンピュータ音楽の博士号を取得し、KORG の音源開発に参加。2019〜2023年は bFaaaP にボランティアとして参加。 |
...
- **▶ [夏の響演2022 — 7大学合同演奏会](https://youtu.be/uXMLea6_eKM)**（豊洲シビックセンターホール, 2022‑09‑05）—— 東工大（現・**東京科学大学**）**プラタナス**のメンバーが **bFaaaP** で「花の歌」を演奏。他大学の奏者と並ぶ**正式な合同演奏会**での使用例（[イベント情報](https://natsunokyoen2022.github.io/)）。
...
- 🙋 **製作のヘルプ：** [コミュニティ・サポート](ai-support.md) —— GitHub Discussions で質問
