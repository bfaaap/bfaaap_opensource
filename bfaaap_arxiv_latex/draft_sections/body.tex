% Shared paper body (Introduction -> Conclusion), included by BOTH
% main.tex (arXiv, article) and main_taccess.tex (TACCESS, acmart).
% Figures use \Description{} (acmart defines it; article no-ops it via
% \providecommand). Edit here once; both papers stay in sync.
