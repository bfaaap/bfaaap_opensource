...
![Disassembled Pro: airback wedge, aluminium drive unit, motor and boards](pro_components_airback_and_drive.jpg)

**Air valve.** The metal quick valve of the airback — the **rubber‑visible side is
the air input** (per the device co‑author).

![Airback metal air valve close-up](airback_air_valve.jpg)
...
![Pro I/O panel: RJ45, toggle switch, 8-pin power connector](pro_io_panel.jpg)

**Power connector.** The 8‑pin (M15‑type) power connector used on the prototype.

![8-pin (M15-type) power connector](pro_power_connector.jpg)

**3D‑printed panels.** The original panel (black) and a re‑printed copy (grey),
illustrating the print‑it‑yourself enclosure.

![3D-printed I/O panels, original and reprint](pro_printed_io_panels.jpg)
