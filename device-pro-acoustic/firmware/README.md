...
| `bFaaaP_autopro_pico_v039B_20250725.ino` | RP2040 / Pico | **IQ / Fortiq motor** version |
| `…_v039B_…_shishido_v.ino` | RP2040 / Pico | v039B variant |
| `bFaaaP_autopro_pico_v052B_step_20251111.ino` | RP2040 / Pico | **stepper** version (latest) — ⚠ development snapshot |

> ⚠ **Motor change:** the IQ / Fortiq motor was **discontinued**, so the latest
> design (v052B) switched to a **closed‑loop stepping motor**. The IQ library
> below applies only to the v039B (IQ) version. The latest sketch is not yet
> build‑ready — see the caveats in `DESIGN-HIGHLIGHTS.md`.
